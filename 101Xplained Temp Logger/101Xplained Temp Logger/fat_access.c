...
{
    USART_printf("FAT details:\r\n");
    USART_printf(" Type =%s", (fs->fat_type == FAT_TYPE_32) ? "FAT32": "FAT16");
    USART_printf(" Root Dir First Cluster = %x\r\n", fs->rootdir_first_cluster);
    USART_printf(" FAT Begin LBA = 0x%x\r\n",fs->fat_begin_lba);
    USART_printf(" Cluster Begin LBA = 0x%x\r\n",fs->cluster_begin_lba);
    USART_printf(" Sectors Per Cluster = %d\r\n", fs->sectors_per_cluster);
}
//-----------------------------------------------------------------------------
